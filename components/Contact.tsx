    ...
    <section id="contact" className="py-16 bg-gradient-to-br from-emerald-600 to-emerald-500 text-white">
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3"><a href={COMPANY.phoneHref} className="inline-flex items-center justify-center gap-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur px-4 py-2 text-white font-medium transition"><Phone className="w-5 h-5" /> Llamar</a><a href={COMPANY.whatsappHref} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-[#25D366] text-[#25D366] bg-white hover:bg-[#25D366] hover:text-white px-5 py-2 font-medium shadow-sm transition"><FaWhatsapp className="text-lg" /> WhatsApp</a><a href={`mailto:${COMPANY.email}`} className="inline-flex items-center justify-center gap-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur px-4 py-2 text-white font-medium transition"><Mail className="w-5 h-5" /> Email</a></div>
        </div>
